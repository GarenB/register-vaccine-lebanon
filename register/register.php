...
<div class="back-pic">
  ...
  <h3 >Register </h3>
            ...
            <form id="optionsUp" action="register.php" method="post">
               <div class="row" >
                    <div class="col-md-6">
                        <div class="form-group">
                        <label for="username">Place</label>
          <div class="form-select">
                  <select class="form-control select1" name="place" id="location" >
                  <option value=""></option>
                  <?php 
                  include("../config.php");                    
          ...
          <div class="form-select">
                  <select class="form-control select2" name="vaccineID" id="location" >
                  <option value=""></option>
                  <?php 
                  include("../config.php");                    
        ...
        <input class="form-control select2" type="time" name="time" id="cityname" class="form-control">
                        </div>
            ...
            <form id="optionsUp2" action="../registerFor.php" method="post">
   ...
   if(isset($_POST['btnSubmit'])){
     ...
     if(empty($vaccineID) AND empty($month) AND empty($time)){ //first
       ...
       //header("Location: ../search.php");
        echo "<script>window.location.href='\register.php'; alert('Please enter an attribute');</script>";
     }
     else
     {
