...
<div class="back-pic">
  <div class="admin">
  <h3  class="profile-left" >Moderna</h3>
  </div>
</div>
...
<div class="back-pic4">
<div>
 <h5 class="pfizer-intro">Moderna, Inc is an American pharmaceutical and biotechnology company based in Cambridge, Massachusetts. It focuses on vaccine technologies based on messenger RNA. </h5>
 </div>   
<h4 class="data-title2">Charts: % of people from each city that registered to take Moderna vaccine</h4>
...
<?php 
    ...
    $sql = "SELECT * FROM register, users, placedatetime, locations WHERE users.LocationID=locations.locationID AND register.patientUsername = users.Username AND register.pdtID=placedatetime.ID AND placedatetime.vaccineID='3' ";
                  $result = mysqli_query($db,$sql);             
                  if (mysqli_num_rows($result) > 0) {
