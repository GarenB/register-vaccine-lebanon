...
<div class="back-pic">
  <div class="admin">
  <h3  class="profile-left" >Sputnik</h3>
  </div>
</div>
...
<div class="back-pic5">
<div>
 <h5 class="pfizer-intro">Sputnik V is the world's first registered COVID-19 vaccine with over 91.6% efficacy, developed by Gamaleya Inst. Authorized in 64 countries</h5>
 </div>   
<h4 class="data-title2">Charts: % of people from each city that registered to take Sputnik vaccine</h4>
...
<?php 
    ...
    $sql = "SELECT * FROM register, users, placedatetime, locations WHERE users.LocationID=locations.locationID AND register.patientUsername = users.Username AND register.pdtID=placedatetime.ID AND placedatetime.vaccineID='4' ";
                  $result = mysqli_query($db,$sql);             
                  if (mysqli_num_rows($result) > 0) {
